...
RUN mkdir -p /opt/libs && cd /opt/libs \
    ...
    && wget http://central.maven.org/maven2/org/mongodb/mongodb-driver/3.8.2/mongodb-driver-3.8.2.jar \
    && wget http://central.maven.org/maven2/org/mongodb/mongodb-driver-async/3.8.2/mongodb-driver-async-3.8.2.jar \
    ...
    && wget http://central.maven.org/maven2/org/mongodb/mongodb-driver-core/3.8.2/mongodb-driver-core-3.8.2.jar \
    && wget http://central.maven.org/maven2/org/mongodb/bson/3.8.2/bson-3.8.2.jar \
